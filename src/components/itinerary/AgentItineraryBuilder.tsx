...
import AgentClientDetails from './AgentClientDetails';
...
import AgentReviewCosting from './AgentReviewCosting';
import AgentFinalSummary from './AgentFinalSummary';
import Layout from '../Layout';

const AgentItineraryBuilder: React.FC = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return <AgentClientDetails onNext={handleClientNext} />;
      case 2:
        return client ? (
          <ItinerarySelection 
            client={client} 
  ...
  return (
    <Layout title="Itinerary Builder" subtitle="Create travel packages for your clients">
      {renderStep()}
    </Layout>
  );
};

export default AgentItineraryBuilder;