...
import SalesReviewCosting from './SalesReviewCosting';
...
const SalesItineraryBuilder: React.FC<SalesItineraryBuilderProps> = ({ onBackToDashboard }) => {
  ...
  if (currentStep > 1) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 py-4 md:py-8">
  ...
  return (
    <Layout title="Sales Itinerary Builder" subtitle="Create compelling travel packages for sales prospects">
      {renderStep()}
    </Layout>
  );
};

export default SalesItineraryBuilder;