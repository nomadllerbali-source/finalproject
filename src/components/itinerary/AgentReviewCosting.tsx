...
const AgentReviewCosting: React.FC<AgentReviewCostingProps> = ({ client, dayPlans, onNext, onBack }) => {
  const { state } = useData();
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
        <div className="bg-gradient-to-r from-teal-600 to-green-600 px-4 md:px-8 py-4 md:py-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-white">Review & Pricing</h2>
              <p className="text-teal-100 mt-1 text-sm md:text-base">Step 3 of 4 - Final Review and Agent Pricing</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 md:p-8">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-teal-50 rounded-xl p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="flex items-center">
                <div className="bg-gradient-to-r from-teal-500 to-green-500 text-white rounded-xl p-4 md:p-6 w-full text-center">
...
export default AgentReviewCosting;